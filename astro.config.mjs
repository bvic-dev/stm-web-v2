...
export default defineConfig({
  ...
  integrations: [sitemap({
    filter: (page) =>
      ...
      page !== SITE_URL + '/pt/mobile/privacy/' &&
      page !== SITE_URL + '/pt-pt/mobile/privacy/',
    i18n: {
      defaultLocale: DEFAULT_LOCALE,
